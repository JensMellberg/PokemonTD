...
@dso_cache = dso_local local_unnamed_addr global [280 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 118094454, ; hash 0x709fa76, from name: libaot-PokemonTDAndroid.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 399936294, ; hash 0x17d68b26, from name: PokemonTDCore
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1088027157, ; hash 0x40d9fa15, from name: PokemonTDEngine.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1222272508, ; hash 0x48da65fc, from name: PokemonTDCore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokemonTDCore.dll.so
		ptr null; void* handle (0x0)
	}, ; 73
	...
	%struct.DSOCacheEntry {
		i64 1380144503, ; hash 0x52435577, from name: aot-PokemonTDEngine
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PokemonTDEngine.dll.so
		ptr null; void* handle (0x0)
	}, ; 84
	...
	%struct.DSOCacheEntry {
		i64 1506160701, ; hash 0x59c6303d, from name: libaot-PokemonTDCore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokemonTDCore.dll.so
		ptr null; void* handle (0x0)
	}, ; 96
	...
	%struct.DSOCacheEntry {
		i64 2057129882, ; hash 0x7a9d4f9a, from name: libaot-PokemonTDEngine.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PokemonTDEngine.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 2117292875, ; hash 0x7e33534b, from name: aot-PokemonTDCore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokemonTDCore.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 2603188740, ; hash 0x9b298204, from name: aot-PokemonTDAndroid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-PokemonTDAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 169
	...
	%struct.DSOCacheEntry {
		i64 2682533123, ; hash 0x9fe43503, from name: aot-PokemonTDEngine.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PokemonTDEngine.dll.so
		ptr null; void* handle (0x0)
	}, ; 177
	...
	%struct.DSOCacheEntry {
		i64 2881644764, ; hash 0xabc268dc, from name: aot-PokemonTDCore
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokemonTDCore.dll.so
		ptr null; void* handle (0x0)
	}, ; 184
	...
	%struct.DSOCacheEntry {
		i64 2971570681, ; hash 0xb11e91f9, from name: aot-PokemonTDAndroid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-PokemonTDAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 193
	%struct.DSOCacheEntry {
		i64 2975226868, ; hash 0xb1565bf4, from name: PokemonTDEngine
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PokemonTDEngine.dll.so
		ptr null; void* handle (0x0)
	}, ; 194
	...
	%struct.DSOCacheEntry {
		i64 3158038474, ; hash 0xbc3bd7ca, from name: libaot-PokemonTDCore.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-PokemonTDCore.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	...
	%struct.DSOCacheEntry {
		i64 3439324329, ; hash 0xccffeca9, from name: libaot-PokemonTDAndroid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-PokemonTDAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 222
	...
	%struct.DSOCacheEntry {
		i64 3738240415, ; hash 0xded1059f, from name: PokemonTDAndroid
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-PokemonTDAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 3806897442, ; hash 0xe2e8a522, from name: PokemonTDAndroid.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.10_name, ; name: libaot-PokemonTDAndroid.dll.so
		ptr null; void* handle (0x0)
	}, ; 245
	...
	%struct.DSOCacheEntry {
		i64 3902281490, ; hash 0xe8981712, from name: libaot-PokemonTDEngine
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-PokemonTDEngine.dll.so
		ptr null; void* handle (0x0)
	}, ; 253
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [42 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
